...
class Dataset():
    ...
    def load_tokenizer(self):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(
            self.model_name,
            model_max_length=1024,  # The maximum length (in number of tokens) for the inputs 
            padding_side="left",
            use_fast=False,)

        self.tokenizer.pad_token = self.tokenizer.eos_token #  eos_token: representing the end of a sentence
