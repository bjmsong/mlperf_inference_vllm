...
def get_args():
    ...
    parser.add_argument("--use-cached-outputs", type=str, default=False, help="")
...
def main():
    ...
    sut.start()  # 调用sut.process_queries()
    lgSUT = lg.ConstructSUT(sut.issue_queries, sut.flush_queries)
    log.info("Starting Benchmark run")
    lg.StartTestWithLogSettings(lgSUT, sut.qsl, settings, log_settings, args.audit_conf)  # 调用sut.issue_queries()
